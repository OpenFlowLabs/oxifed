...
pub mod article {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_article { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: article struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "descriptor")] pub descriptor : String , # [serde (rename = "title")] pub title : String , # [serde (rename = "date")] pub date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "content")] pub content : String , # [serde (rename = "content_html")] pub content_html : String , # [serde (rename = "draft")] pub draft : bool , # [serde (rename = "tags")] pub tags : Vec < String > , # [serde (rename = "noteId")] pub note_id : String } [$ ($ scalar_field) , +] } } ; }
