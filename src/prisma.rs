    ...
    impl Into<::prisma_client_rust::Selection> for WithParam {
        fn into(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::Articles(args) => {
                    let (arguments, mut nested_selections) = args.to_graphql();
                    nested_selections . extend (< super :: article :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()) ;
                    ::prisma_client_rust::Selection::new(
                        articles::NAME,
                        None,
                        arguments,
...
pub mod article {
    ...
    #[macro_export]
    macro_rules ! _include_article { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: article :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: article :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: article :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: article :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: article :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: article :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: article :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: article :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { author , note } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub id : String , pub descriptor : String , pub title : String , pub date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , pub content : String , pub content_html : String , pub author_id : String , pub draft : bool , pub tags : Vec < String > , pub note_id : String , pub published_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , $ (pub $ field : crate :: prisma :: article :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (id) , stringify ! (descriptor) , stringify ! (title) , stringify ! (date) , stringify ! (content) , stringify ! (content_html) , stringify ! (author_id) , stringify ! (draft) , stringify ! (tags) , stringify ! (note_id) , stringify ! (published_at)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: article :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: article :: id :: NAME , & self . id) ? ; state . serialize_field (crate :: prisma :: article :: descriptor :: NAME , & self . descriptor) ? ; state . serialize_field (crate :: prisma :: article :: title :: NAME , & self . title) ? ; state . serialize_field (crate :: prisma :: article :: date :: NAME , & self . date) ? ; state . serialize_field (crate :: prisma :: article :: content :: NAME , & self . content) ? ; state . serialize_field (crate :: prisma :: article :: content_html :: NAME , & self . content_html) ? ; state . serialize_field (crate :: prisma :: article :: author_id :: NAME , & self . author_id) ? ; state . serialize_field (crate :: prisma :: article :: draft :: NAME , & self . draft) ? ; state . serialize_field (crate :: prisma :: article :: tags :: NAME , & self . tags) ? ; state . serialize_field (crate :: prisma :: article :: note_id :: NAME , & self . note_id) ? ; state . serialize_field (crate :: prisma :: article :: published_at :: NAME , & self . published_at) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , id , descriptor , title , date , content , content_html , author_id , draft , tags , note_id , published_at } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: article :: $ field :: NAME) , + , crate :: prisma :: article :: id :: NAME , crate :: prisma :: article :: descriptor :: NAME , crate :: prisma :: article :: title :: NAME , crate :: prisma :: article :: date :: NAME , crate :: prisma :: article :: content :: NAME , crate :: prisma :: article :: content_html :: NAME , crate :: prisma :: article :: author_id :: NAME , crate :: prisma :: article :: draft :: NAME , crate :: prisma :: article :: tags :: NAME , crate :: prisma :: article :: note_id :: NAME , crate :: prisma :: article :: published_at :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: article :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: article :: id :: NAME => Ok (Field :: id) , crate :: prisma :: article :: descriptor :: NAME => Ok (Field :: descriptor) , crate :: prisma :: article :: title :: NAME => Ok (Field :: title) , crate :: prisma :: article :: date :: NAME => Ok (Field :: date) , crate :: prisma :: article :: content :: NAME => Ok (Field :: content) , crate :: prisma :: article :: content_html :: NAME => Ok (Field :: content_html) , crate :: prisma :: article :: author_id :: NAME => Ok (Field :: author_id) , crate :: prisma :: article :: draft :: NAME => Ok (Field :: draft) , crate :: prisma :: article :: tags :: NAME => Ok (Field :: tags) , crate :: prisma :: article :: note_id :: NAME => Ok (Field :: note_id) , crate :: prisma :: article :: published_at :: NAME => Ok (Field :: published_at) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut id = None ; let mut descriptor = None ; let mut title = None ; let mut date = None ; let mut content = None ; let mut content_html = None ; let mut author_id = None ; let mut draft = None ; let mut tags = None ; let mut note_id = None ; let mut published_at = None ; while let Some (key) = map . next_key () ? { match key { Field :: id => { if id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: id :: NAME)) ; } id = Some (map . next_value () ?) ; } Field :: descriptor => { if descriptor . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: descriptor :: NAME)) ; } descriptor = Some (map . next_value () ?) ; } Field :: title => { if title . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: title :: NAME)) ; } title = Some (map . next_value () ?) ; } Field :: date => { if date . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: date :: NAME)) ; } date = Some (map . next_value () ?) ; } Field :: content => { if content . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: content :: NAME)) ; } content = Some (map . next_value () ?) ; } Field :: content_html => { if content_html . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: content_html :: NAME)) ; } content_html = Some (map . next_value () ?) ; } Field :: author_id => { if author_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: author_id :: NAME)) ; } author_id = Some (map . next_value () ?) ; } Field :: draft => { if draft . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: draft :: NAME)) ; } draft = Some (map . next_value () ?) ; } Field :: tags => { if tags . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: tags :: NAME)) ; } tags = Some (map . next_value () ?) ; } Field :: note_id => { if note_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: note_id :: NAME)) ; } note_id = Some (map . next_value () ?) ; } Field :: published_at => { if published_at . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: published_at :: NAME)) ; } published_at = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: article :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: $ field :: NAME)) ? ;) * let id = id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: id :: NAME)) ? ; let descriptor = descriptor . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: descriptor :: NAME)) ? ; let title = title . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: title :: NAME)) ? ; let date = date . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: date :: NAME)) ? ; let content = content . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: content :: NAME)) ? ; let content_html = content_html . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: content_html :: NAME)) ? ; let author_id = author_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: author_id :: NAME)) ? ; let draft = draft . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: draft :: NAME)) ? ; let tags = tags . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: tags :: NAME)) ? ; let note_id = note_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: note_id :: NAME)) ? ; let published_at = published_at . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: article :: published_at :: NAME)) ? ; Ok (Data { id , descriptor , title , date , content , content_html , author_id , draft , tags , note_id , published_at , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["id" , "descriptor" , "title" , "date" , "content" , "content_html" , "author" , "authorId" , "draft" , "tags" , "note" , "noteId" , "publishedAt"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: article :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; author : $ selection_mode : ident { $ ($ selections : tt) + }) => { author :: Data } ; (@ field_type ; author) => { crate :: prisma :: actor :: Data } ; (@ field_type ; note : $ selection_mode : ident { $ ($ selections : tt) + }) => { note :: Data } ; (@ field_type ; note) => { crate :: prisma :: note :: Data } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Article" , available relations are "author, note")) } ; (@ field_module ; author : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: actor :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; note : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: note :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; author $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: article :: IncludeParam > :: into (crate :: prisma :: article :: author :: Include :: $ selection_mode (crate :: prisma :: actor :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; author $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: article :: IncludeParam > :: into (crate :: prisma :: article :: author :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; note $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: article :: IncludeParam > :: into (crate :: prisma :: article :: note :: Include :: $ selection_mode (crate :: prisma :: note :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; note $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: article :: IncludeParam > :: into (crate :: prisma :: article :: note :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: article :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; id) => { "id" } ; (@ field_serde_name ; descriptor) => { "descriptor" } ; (@ field_serde_name ; title) => { "title" } ; (@ field_serde_name ; date) => { "date" } ; (@ field_serde_name ; content) => { "content" } ; (@ field_serde_name ; content_html) => { "content_html" } ; (@ field_serde_name ; author) => { "author" } ; (@ field_serde_name ; author_id) => { "authorId" } ; (@ field_serde_name ; draft) => { "draft" } ; (@ field_serde_name ; tags) => { "tags" } ; (@ field_serde_name ; note) => { "note" } ; (@ field_serde_name ; note_id) => { "noteId" } ; (@ field_serde_name ; published_at) => { "publishedAt" } ; }
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_article { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: article struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "descriptor")] pub descriptor : String , # [serde (rename = "title")] pub title : String , # [serde (rename = "date")] pub date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "content")] pub content : String , # [serde (rename = "content_html")] pub content_html : String , # [serde (rename = "authorId")] pub author_id : String , # [serde (rename = "draft")] pub draft : bool , # [serde (rename = "tags")] pub tags : Vec < String > , # [serde (rename = "noteId")] pub note_id : String , # [serde (rename = "publishedAt")] pub published_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (descriptor, title, date, content, content_html, author, note, mut _params): (
                String,
                String,
                ::prisma_client_rust::chrono::DateTime<::prisma_client_rust::chrono::FixedOffset>,
                String,
